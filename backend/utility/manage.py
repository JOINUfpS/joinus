...
from asn_utility.settings import EUREKA_SERVER, APP_NAME, APPLICATION_PORT, configuration


def main():
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'asn_utility.settings')
