"""
Django settings for asn_utility project.
...
SECRET_KEY = '%@j+h)$c4fx+c58*wncl^&#mz8g-2n$@zfmne14wj#4wf-4a=1'
...
CONTEXT_PATH = general_config.get('BASE_PATH', 'utilities/')
API_GATEWAY = general_config.get('API_GATEWAY', 'asn_gateway/')

APP_NAME = general_config.get('APP_NAME', 'asn_utility')
APPLICATION_PORT = general_config.get('APPLICATION_PORT', 8095)
...
WSGI_APPLICATION = 'asn_utility.wsgi.application'
    ...
    'default': {
        ...
        "CLIENT": {
            ...
            'host': params.get('HOST_DATABASE', 'mongodb+srv://user:04052018@tesisasn.0rbje.mongodb.net/'
                                                'asn_utility?retryWrites=true&w=majority'),
