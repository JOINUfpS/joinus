"""
Django settings for asn_user project.
...
SECRET_KEY = '5uc@resx(1l^tj8e_ggig)53&mw+@#8h&@s*9sy3wjv=1f-4)3'
...
CONTEXT_PATH = general_config.get('BASE_PATH', 'users/')
API_GATEWAY = general_config.get('API_GATEWAY', 'api_gateway/')

APP_NAME = general_config.get('APP_NAME', 'asn_user')
APPLICATION_PORT = general_config.get('APPLICATION_PORT', 8092)
    ...
    'default': {
        ...
        "CLIENT": {
            ...
            'host': params.get('HOST_DATABASE', 'mongodb+srv://user:04052018@tesisasn.0rbje.mongodb.net/'
                                                'asn_user?retryWrites=true&w=majority'),
