"""
Django settings for asn_publication project.
...
SECRET_KEY = 'ink+66!72ro(riohcic&mwg@^=qmnte0ymt9wkpuznsy249z96'
...
CONTEXT_PATH = general_config.get('BASE_PATH', 'publications/')
API_GATEWAY = general_config.get('API_GATEWAY', 'asn_gateway/')

APP_NAME = general_config.get('APP_NAME', 'asn_publication')
APPLICATION_PORT = general_config.get('APPLICATION_PORT', 8093)
...
ROOT_URLCONF = 'asn_publication.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR + '/publication/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'asn_publication.wsgi.application'
