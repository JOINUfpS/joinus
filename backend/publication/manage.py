...
from asn_publication.settings import EUREKA_SERVER, APP_NAME, APPLICATION_PORT, configuration


def main():
    """Run administrative tasks."""
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'asn_publication.settings')
